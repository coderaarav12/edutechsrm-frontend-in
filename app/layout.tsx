...
export const metadata: Metadata = {
  ...
  title: {
    default: "edutechsrm | SRMIST KTR timetable, attendance & marks",
    template: "%s | edutechsrm",
  },
  description:
    "Free SRMIST KTR dashboard for timetable, attendance, marks, CGPA, assignments and academic planner — all your SRM data live from Academia in one place.",
  keywords: [
    "edutechsrm",
  ...
  openGraph: {
    ...
    siteName: "edutechsrm",
    title: "edutechsrm | SRMIST KTR timetable, attendance & marks",
    description:
      "Free SRMIST KTR dashboard for timetable, attendance, marks, CGPA, assignments and academic planner — all your SRM data live from Academia in one place.",
    locale: "en_IN",
    images: [
  ...
  twitter: {
    ...
    title: "edutechsrm | SRMIST KTR timetable, attendance and marks dashboard",
    description:
      "Free SRMIST KTR student dashboard for timetable, attendance, marks, CGPA, assignments and academic calendar.",
    images: ["/og-image.png"],
  },
  icons: {
    icon: [
  ...
  const structuredData = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        description:
          "Student dashboard for SRMIST KTR timetable, attendance, marks, CGPA and academic planning.",
      },
    ],
  }
