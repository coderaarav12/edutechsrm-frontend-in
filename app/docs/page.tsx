    ...
    <>
      ...
      <main className="min-h-screen pt-28 pb-16 px-4">
        <div className="mx-auto max-w-3xl">
          ...
          >
            <span className="inline-flex items-center gap-2 rounded-full border border-cyan-300/25 bg-cyan-300/10 px-3 py-1.5 text-xs font-black uppercase tracking-[0.18em] text-cyan-300">
