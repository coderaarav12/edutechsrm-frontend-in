...
const _ANDROID_AES_PASSPHRASE_XOR: Uint8Array = new Uint8Array([
  63, 62, 47, 46, 63, 57, 50, 41, 40, 55, 5, 47, 54, 46, 40, 59, 5, 41, 63, 57, 47, 40, 63, 5,
  59, 63, 41, 104, 111, 108, 5, 49, 63, 35, 5, 104, 106, 104, 108, 5, 57, 54, 51, 63, 52, 46,
  5, 41, 51, 61, 52, 51, 52, 61,
])
const _ANDROID_XOR_MASK = 0x5a
